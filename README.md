...
전체 보기의 달력 위 `다가오는 일정`에서 제목, 날짜와 시간을 입력해 일정을 등록합니다. `하루 끝` 버튼을 누르면 선택한 날짜의 시간을 `23:59`로 바로 설정할 수 있습니다. 일정은 가장 가까운 마감 순으로 정렬되며, 세 개를 초과하면 목록 안에서 세로로 스크롤할 수 있습니다. 카드를 누르면 제목과 마감시간을 수정하거나 일정을 삭제할 수 있습니다.
